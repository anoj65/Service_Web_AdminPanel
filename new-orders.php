  ...
  <div class="main-wrapper">
    ...
    <div class="page-wrapper">
      ...
      <div class="page-content">
        <div class="card">
          <div class="card-body">
            <h6 class="card-title mb-3">New Orders</h6>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="text-center">
                      ...
                      <a href="#"  class="text-success" onclick="showSwal('mixin')" ><i data-feather="check-circle" class="icon"></i></a>
                      <a href="#"  class="text-danger mx-2"><i data-feather="x" class="icon" onclick="showSwal('passing-parameter-execute-cancel')"></i></a>
                    </td>
                  </tr>
                </tbody>
              </table>
